    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50">
          ...
          {/* Command Palette - Fixed at 1/4 from top */}
          <div className="fixed top-[25vh] left-1/2 -translate-x-1/2 w-full max-w-xl px-4">
            <motion.div 
              role="dialog"
              aria-modal="true"
            ...
            >
              <Command label="Product Search" loop shouldFilter={false}>
                <div className="bg-white rounded-xl shadow-2xl border border-neutral-200/80 overflow-hidden backdrop-blur-xl">
                  ...
                  {/* Results - Only this section expands/collapses */}
